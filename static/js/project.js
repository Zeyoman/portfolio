 ...
 */
    ...
    var searchBar = $('#searchBarContainer').height() + 40
    $('#projectList').css('max-height',headerHeight - searchBar)
 ...
 */
    ...
    document.getElementById('searchBar').addEventListener('input', function() {
        ...
        projects.forEach(function(project) {
            ...
            if (title.includes(searchTerm)) {
                ...
                var lengthDisplayNone = $('.projectContainer:hidden');
                if(projects.length == lengthDisplayNone.length){
    ...
    window.addEventListener('resize',function(){
        $('.projectContainer').each(function(){
            widthForHeight = $(this).width()
            $(this).css('height',widthForHeight)
        })
